...
Shader "Synergiance/AckToon/MMD" {
	Properties {
		// Main Maps
		...
		_SphereAddTex ("Additive MatCap", 2D) = "black" {}
		_SphereMulTex ("Multiplicative MatCap", 2D) = "white" {}
		_SphereMask ("MatCap Mask Texture", 2D) = "white" {}
	...
	FallBack "Diffuse"
	CustomEditor "Synergiance.Shaders.AckToon.MikuMikuInspector"
}